      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="hidden md:flex justify-between items-start">
          ...
          <div className="w-1/3">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/events" className="text-gray-400 hover:text-white transition-colors duration-300">
                  Events
                </Link>
              </li>
              <li>
          ...
          <div className="w-1/3">
            ...
            <p className="text-gray-400 text-sm mb-2">
              <span className="font-bold">Email:</span> nexttilligent@gmail.com
            </p>
            <p className="text-gray-400 text-sm mb-2">
              <span className="font-bold">Phone:</span> +234 7044762988
            </p>
            <p className="text-gray-400 text-sm mb-4">
              <span className="font-bold">Address:</span> University of Ibadan, Ibadan, Nigeria
            </p>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://instagram.com/nextnigeria" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-300">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="md:hidden">
          ...
          <div className="text-center mb-6">
            ...
            <p className="text-gray-400 text-sm mb-2">
              <span className="font-bold">Phone:</span> +234 123 456 7890
            </p>
            <p className="text-gray-400 text-sm">
              <span className="font-bold">Address:</span> University of Ibadan, Ibadan, Nigeria
            </p>
